...
public class BookDAO {
    ...
    public Book create(Book book) throws SQLException {
        ...
        String sql = "INSERT INTO books (isbn, title, author_id, publisher_id, category_id, "
                ...
                + "total_copies, available_copies, price, location, status) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) "
     ...
     *
     * @param bookId             ID book yang di-update
     ...
     * Hanya decrease jika available copies > 0
     *
     ...
     * Hanya increase jika available copies < total copies
     *
    ...
    /**
     * Helper method untuk memetakan ResultSet ke objek Book
     */
